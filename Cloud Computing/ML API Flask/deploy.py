...
model_path = os.path.join(os.path.dirname(__file__), '../Machine Learning/Image Recognition/lettuce_model.h5')
...
@app.route('/')
def home():
    message = "Welcome to our Haivest machine learning model endpoints. Before that, please first register and login."
