...
buat db MySQL: gcloud sql databases create haivest --instance=haivest-instance

gcloud sql connect haivest-instance --user=root --quiet --project=capstone-426107 <<EOF
USE haivest;
CREATE TABLE user (
  id INT AUTO_INCREMENT PRIMARY KEY,
  username VARCHAR(255) UNIQUE NOT NULL,
